...
if SOURCE != s:
    print("So sad, you have changed source, change it back to ` https://github.com/DONOFTELEGRAM/Chatgpt-bot `  else I won't work")
    sys.exit(1)  
if DEVELOPER!=u:
    print("So sad, you have changed Updates, change it back to `D0N_OF_TELEGRAM ` else I won't work")
    sys.exit(1)
if UPDATE_CHNL!=d:
    print("So sad, you have change developer, change it back to `DONOFTELEGRAM ` else I won't work")
    sys.exit(1)
...
#-----------CREDITS -----------
# telegram : @D0N_OF_TELEGRAM
# github : DONOFTELEGRAM 
